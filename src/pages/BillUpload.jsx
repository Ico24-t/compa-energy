...
const BillUpload = () => {
  ...
  const handleConfermaOfferta = async () => {
    ...
    try {
      ...
      // Salva file su Storage — non bloccante, il flusso continua anche se fallisce
      if (fileOriginale && leadId) {
        try { await salvaFileStorage(fileOriginale, leadId) } 
        catch (e) { console.warn('Storage non disponibile, continuo senza:', e) }
      }
